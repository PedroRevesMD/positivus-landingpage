...
// FIX: Arrumar Tamanho dos Cards (alguns estão com menos tamanho do que outros)
  ...
  return (
    <section className="max-w-screen m-8 lg:m-20">
      <div className="flex flex-col lg:flex-row gap-x-8 items-center">
        <h3 className="font-medium bg-lime-green p-2 rounded-xl text-dark-gray text-2xl font-grotesk">Services</h3>
        <p className="text-base font-grotesk max-w-[520px] my-4 text-center lg:text-start">At our digital marketing agency, we offer a range of services to help businesses grow and succeed online. These services include:</p>
      </div>
