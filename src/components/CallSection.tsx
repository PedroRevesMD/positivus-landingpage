...
export default function CallSection() {
  return (
    <section className="bg-light-gray m-20 max-w-screen flex flex-col items-center justify-between lg:flex-row px-12 rounded-2xl">
      <div className="font-grotesk text-center lg:text-start my-8 max-w-lg flex flex-col gap-y-2">
        <h3 className="font-semibold text-3xl">Let’s make things happen</h3>
